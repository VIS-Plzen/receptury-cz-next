...
// Component Variants
const cv = {
  base: "inline-flex items-center justify-center whitespace-nowrap text-xs md:text-sm text-primary-600 rounded-md font-medium disabled:pointer-events-none disabled:opacity-60",
  variant: {

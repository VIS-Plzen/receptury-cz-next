...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center gap-1 rounded-full border-2 border-primary-200 bg-white p-1 focus-within:ring-4 focus-within:ring-primary-500/50",
      className
    )}
    {...props}
  />
